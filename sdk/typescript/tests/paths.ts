...
/** The conformance vectors; `WORLDVIEW_VECTORS` points the suite at a freshly generated set elsewhere. */
export const VECTORS = process.env.WORLDVIEW_VECTORS ?? path.join(REPO_ROOT, "conformance", "vectors");
